---
layout: post   
title:  "Форма поиска банка Пример. Часть 6. Обработка событий клавиатуры"   
date:   2022-02-23   
categories: CroLua  
---

Сегодня мы завершаем цикл статей, посвященный описанию процесса разработки управляющей формы, предназначенной для отбора кандидатов на работу в демонстрационном банке кадрового агентства Primer1.
...
Все материалы можно посмотреть и скачать [здесь](https://github.com/sinilga/cronospro/blob/master/assets/sources/findform).
