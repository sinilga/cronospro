...
tags: [ CronosPro, Lua, ОконныеФормы, TreeControl ] 
---
...
https://github.com/sinilga/sinilga.github.io/blob/ee02588f4151f7bc8d7966086acad40043ab5201/assets/sources/findform/module.lua#L111-L182

## Дополнительные материалы
- Форма [Города](/assets/sources/findform) и текст ее [модуля](/assets/sources/findform);
- Текст [модуля формы поиска](https://github.com/sinilga/sinilga.github.io/blob/2f9e9ddb25c439892609766b5711a439df94a17e/assets/sources/findform/module.lua) на данный момент
