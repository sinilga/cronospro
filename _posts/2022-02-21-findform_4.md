---
layout: post 
title:  "Форма поиска банка Primer1. Часть 4. Диалоговое окно с деревом" 
date:   2022-02-21 
categories: CroLua 
---

# Диалоговое окно с деревом

Это очередная из серии статей, описывающих процесс разработки управляющей формы, предназначенной для отбора кандидатов на работу в демонстрационном банке кадрового агентства Primer1.

---

<details>
<summary>Предыдущие статьи серии:</summary>
<p><a href="">Часть 1. Готовим макет формы</a></p>
<p><a href="">Часть 2. Организуем контроль правильности ввода</a></p>
<p><a href="">Часть 3. Добавляем диалоговые окна</a></p>
</details>
...
https://github.com/sinilga/cronospro/blob/ee02588f4151f7bc8d7966086acad40043ab5201/assets/sources/findform/module.lua#L111-L182

## Дополнительные материалы
- Форма [Города](/assets/sources/findform) и текст ее [модуля](/assets/sources/findform);
- Текст [модуля формы поиска](https://github.com/sinilga/cronospro/blob/2f9e9ddb25c439892609766b5711a439df94a17e/assets/sources/findform/module.lua) на данный момент
